...
public class Question {
	...
	public Question(int qid, String questions, String optionA, String optionB, String optionC, String optionD,
			String correctAns) {
		super();
		this.qid = qid;
	...
	public String toString() {
		return "Question [qid=" + qid + ", questions=" + questions + ", optionA=" + optionA + ", optionB=" + optionB
